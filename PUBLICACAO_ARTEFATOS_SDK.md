...
```text
build/ios-sdk-release/NossoFlutterSDK-Debug-1.0.1.zip
build/ios-sdk-release/NossoFlutterSDK-Release-1.0.1.zip
```
...
s.source = {
  :http => 'https://github.com/glaucohd/nosso-flutter-sdk/releases/download/1.0.1/NossoFlutterSDK-Release-1.0.1.zip'
}
```
...
2. Publicar zip na release 1.0.1.
...
```sh
sh scripts/package_android_sdk_release.sh 1.0.1
```

Saida atual da POC:

```text
build/android-sdk-release/NossoFlutterSDK-Android-1.0.1.zip
```
...
```text
com.glaucohd:nosso-flutter-sdk:1.0.1
...
Android -> implementation("com.glaucohd:nosso-flutter-sdk:1.0.1")
```
